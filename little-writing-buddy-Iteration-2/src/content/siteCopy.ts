...
export const auth = {
  ...
  signUpSuccessBody: (name: string) =>
    `Welcome, ${name}! Your account is saved in this browser so you can sign back in on this device. Nothing was uploaded online.`,
  signUpSuccessContinue: 'Start practising',
  demoTitle: 'Try the demo account',
  demoBody:
    'Use these credentials to explore a profile that already has sample progress and badges.',
  demoEmailLabel: 'Email',
  demoPasswordLabel: 'Password',
  useDemo: 'Fill demo details',
